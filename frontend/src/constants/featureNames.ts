...
export const FEATURE_NAME_EN: Record<string, string> = {
  ...
  w_tox_max:                'Wallet toxicity (max)',
  w_tox_mean:               'Wallet toxicity (mean)',
  w_tox_std:                'Wallet toxicity (std)',
  toxic_w_ratio:            'Toxic wallet ratio',
  toxic_w_count:            'Toxic wallet count',
  ip_tox_mean:              'IP toxicity (mean)',
  ip_tox_max:               'IP toxicity (max)',
  toxic_ip_count:           'Toxic IP count',
  relation_blacklist_ratio: 'Transfer-peer blacklist ratio',
  relation_blacklist_count: 'Transfer-peer blacklist count',
  neighbor_tox_mean:        'Neighbor toxicity (mean)',
  neighbor_tox_max:         'Neighbor toxicity (max)',
  toxic_neighbor_count:     'Toxic neighbor count',
